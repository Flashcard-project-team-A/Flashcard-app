...
export default function LernsetOverview() {
  ...
  useEffect(() => {
    //sobald seite im Browser aufploppt mach direkt xy im hintergrund...."
  ...
  async function fuegeSingleCardHinzu() {
    const neueKarte = { frage: "", antwort: "" };
    const copySingleCard = [...currentSet.karten, neueKarte];
    ...
    // direkt die neue Karte zum Bearbeiten aktivieren
    setActivEditingCard(copySingleCard.length - 1);
  }
  ...
  return (
    <div className="overview-styling">
      {" "}
      ...
      <div className="top-buttons">
        ...
        <button
          className="delete-button glass glass_button"
      ...
      <h3 className="cards-number">
        Karten ({currentSet.karten ? currentSet.karten.length : 0})
      </h3>
      <div className="overview-cards-list">
        {currentSet.karten &&
          currentSet.karten.map((karte, idx) => {
                ...
                <div className="overview-card-question">
                  ...
                  {wirdGeradeEditiert ? (
                    <input
                      ...
                      value={karte.frage}
                      onChange={(e) =>
                        handleCardChange(idx, "frage", e.target.value)
                      }
                      autoFocus
                    />
                  ) : (
                ...
                <div className="overview-card-answer">
                  ...
                  {wirdGeradeEditiert ? (
                    <input
                      ...
                      value={karte.antwort}
                      onChange={(e) =>
                        handleCardChange(idx, "antwort", e.target.value)
                      }
                    />
                  ) : (
                    <p>{karte.antwort}</p>
        ...
        <div className="popup-background">
          <div className="popup-box glass">
            ...
            <div className="popup-buttons">
              <button className="popup-cancel" onClick={handleCancleSet}>
                Abbrechen
              </button>
              <button className="popup-confirm" onClick={loescheLernSet}>
                Löschen
              </button>
            </div>
          </div>

...
export default function Learning() {
  ...
  if (!currentSet.karten || currentSet.karten.length === 0) {
    return (
      <div style={{ color: "white", textAlign: "center", marginTop: "50px" }}>
        Dieses Set hat noch keine karten
      </div>
    );
  }
  ...
  function showNext() {
    ...
    const nextIndex = currentSet.karten.findIndex(
      (card, i) => i > index && !card.solved,
    );
  ...
  return (
    <>
      ...
      <div className="cardsContainer">
        {allSolved ? (
          <div className="learnsession-finished-header">
            <h2>Alles gelernt! </h2>
            <div className="learnsession-finished">
              <button  className="button glass glass_button" onClick={learnAgain}>
                Nochmal lernen
              </button>
              <button  className="button glass glass_button" onClick={navToHomepage}>
                 Fertig
              </button>
            </div>
          </div>
        ...
        <div className="popup-background">
          <div className="popup-box">
            ...
            <div className="popup-buttons">
              <button className="popup-cancel" onClick={handleCancelDelete}>
                Abbrechen
              </button>
              <button className="popup-confirm" onClick={handleConfirmDelete}>
                Löschen
              </button>
            </div>
          </div>
